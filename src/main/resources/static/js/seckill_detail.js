...
const seckill = {
    ...
    URL: {
        now: function () {
            return '/api/v1/seckill/time/now';
        },
        exposer: function (seckillId) {
            return '/api/v1/seckill/' + seckillId + '/exposer';
        },
        execution: function (seckillId, md5) {
            return '/api/v1/seckill/' + seckillId + '/' + md5 + '/execution';
        }
    },
    //验证手机号
            ...
            if (!seckill.validatePhone(killPhone)) {
                ...
                $("#killPhoneBtn").click(function () {
                    ...
                    if (seckill.validatePhone(inputPhone)) {
                        //将手机号写入cookie
                        $.cookie('killPhone', inputPhone, {expires: 7, path: '/api/v1/seckill/'});
                        //刷新页面
