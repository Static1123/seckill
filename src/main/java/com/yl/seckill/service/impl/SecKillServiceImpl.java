package com.yl.seckill.service.impl;

import com.yl.seckill.dao.SeckillMapper;
import com.yl.seckill.dao.SeckillOrderMapper;
        ...
        try {
            ...
            if (insertCount <= 0) {
                ...
                if (updateCount <= 0) {
                    ...
                    return new SeckillExecution(seckillId, StatusEnum.SUCCESS, seckillOrder);
                }
            }
